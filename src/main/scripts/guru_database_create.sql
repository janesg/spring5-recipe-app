...
create table recipe_notes (id bigint not null auto_increment, notes longtext, recipe_id bigint, primary key (id)) engine=InnoDB;
...
alter table recipe add constraint FKcwdyqod6poaoxt3lleysl13au foreign key (notes_id) references recipe_notes (id);
...
alter table recipe_notes add constraint FKg0fxod13o1up2iu1yksjjw2d5 foreign key (recipe_id) references recipe (id);
